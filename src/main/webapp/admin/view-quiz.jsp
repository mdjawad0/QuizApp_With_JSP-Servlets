...
<head>
    ...
    <title>View Quiz | Quiz App</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-2 mr-auto">
                    	<a class="btn btn-success" href="${pageContext.request.contextPath}/admin/quizList">Quiz List</a>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Quiz Detail</h6>
                        </div>
                        <div class="card-body">
